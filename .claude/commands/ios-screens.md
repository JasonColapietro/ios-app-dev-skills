---
description: Produce or review App Store screenshots for an iOS app.
---
...
1. Identify required device sizes.
2. Capture real app states with deterministic demo data.
3. Lead with outcome and differentiator.
4. Frame screenshots as marketing assets, not raw simulator dumps.
